...
var renderContactsList = function () {
  ...
  contacts.forEach(function (contact, i) {
    var newLiContact = createElement("li", "contact__item list-group-item style");
    var newDivFullname = createElement("div", "contact__fullname",`${contacts[i].name} ${contacts[i].surname}`);
    ...
    var newElBtn = createElement("button", "btn btn-light js-btn", "x");
    newElBtn.value = i;
